...
The current mock view represents Orin, Soulkiller, the gateway, and two nodes learned beyond the gateway. Replace the mock `state` payload with real agent output when the collector is ready.
